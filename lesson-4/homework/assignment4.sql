...
-- 1st, I copied the sample tables that are given to us for using.
...
-- 0.1 *  this calculates 10% of that average
-- "select avg(Price) from Product" is average price of all products
